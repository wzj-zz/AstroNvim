...
return {
  {
    ...
    keys = {
      ...
      { "<Leader>ag", desc = "Toggle windows" },
      { "<Leader>ai", desc = "Open input window" },
      { "<Leader>ao", desc = "Open output window" },
      { "<Leader>al", desc = "Session picker" },
      { "<Leader>ar", desc = "Rename session" },
      { "<Leader>as", desc = "Child session picker" },
      { "<Leader>ap", desc = "Provider/model picker" },
      { "<Leader>av", desc = "Variant picker" },
      { "<Leader>am", desc = "MCP picker" },
      { "<Leader>ax", desc = "Restart server" },
      { "<Leader>az", desc = "Toggle window zoom" },
      { "<Leader>ay", mode = "x", desc = "Add selection" },
      { "<Leader>aY", mode = "x", desc = "Add inline selection" },
      { "<Leader>att", desc = "Toggle tool output" },
      { "<Leader>atr", desc = "Toggle reasoning output" },
    },
    dependencies = {
    ...
    opts = {
      ...
      keymap = {
        editor = {
          ...
          ["<Leader>ag"] = { "toggle", desc = "Toggle windows" },
          ["<Leader>ai"] = { "open_input", desc = "Open input window" },
          ["<Leader>ao"] = { "open_output", desc = "Open output window" },
          ["<Leader>al"] = { "select_session", desc = "Session picker" },
          ["<Leader>ar"] = { "rename_session", desc = "Rename session" },
          ["<Leader>as"] = { "select_child_session", desc = "Child session picker" },
          ["<Leader>ap"] = { "configure_provider", desc = "Provider/model picker" },
          ["<Leader>av"] = { "configure_variant", desc = "Variant picker" },
          ["<Leader>am"] = { "mcp", desc = "MCP picker" },
          ["<Leader>ax"] = { restart_opencode_server, desc = "Restart server" },
          ["<Leader>az"] = { "toggle_zoom", desc = "Toggle window zoom" },
